...
import { HistoryDetailsComponent } from "./pages/orderhistory/history-details/history-details.component";
...
const routes: Routes = [
  ...
  },
  {
    path: "vendors",
    loadChildren: () =>
      import("./pages/vendors/vendor.module").then((m) => m.VendorModule),
  },
